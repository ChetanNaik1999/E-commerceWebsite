  ...
  return (
    <BrowserRouter>
        ...
        <header className="row">
            <div>
                <Link to="/" className="brand">MITM MARKET</Link>
            </div>
            <div>
        ...
        <footer class="center">
              ...
              <div>
                ...
                <div>
                    ...
                    <h2>Connect With US</h2>                   
                     ...
                     <a href="https://www.facebook.com/" target="_blank" alt="facebook3"><img src="images/download.png" className="small4"></img></a><h3>Instagram</h3>
                     <a href="https://www.facebook.com" target="_blank" alt="facebook4"><img src="images/facebook.jpg" className="small4"></img></a><h3>Facebook</h3>
                     <a href="https://www.linkedin.com" target="_blank" alt="linkedin2"><img src="images/linkedin.jpg" className="small4"></img></a><h3>Linkedin</h3>
                </div>
                ...
                <div>
                    ...
                    <h3>Sell On MITM</h3>
                    <h3>Sell Under MITM Accelartor</h3>
                    <h3>MITM Global Selling</h3>
                    <h3>Become An Affilate</h3>
                    <h3>fulfillment By MITM</h3>
            ...
            <div className="rights2">All Rights Reserved || www.MITM.com
               </div>   
            </footer>
    </div>
    </BrowserRouter>
