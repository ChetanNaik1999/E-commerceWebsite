...
userRouter.get('/sendemail/:id',expressAsyncHandler(async(req,res) =>{
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      ...
      pass: "ghgjjhj", // generated ethereal password
    }});
    ...
    if (error) {
      ...
      let info = await transporter.sendMail({
          from: '"MITM MARKET 👻" <chetannaik775@gmail.com>', // sender address
          to: user.email, // list of receivers
          subject: "DELIVERY REQUEST AND ORDER DETAILS", // Subject line
          text: "MITM MARKET", // plain text body
          ...
          <h3>Thanks and Regards from AMAZONA TEAM</h3>
          </div>
 `, // html body
      });
      console.log(info);
...
userRouter.post('/sendotp',expressAsyncHandler(async(req,res) =>{
   ...
   if(data){
     ...
     let transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "chetannaik775@gmail.com", // generated ethereal user
        pass: "Chetan@1999", // generated ethereal password
      }});
      ...
      if (error) {
        ...
        let info = await transporter.sendMail({
            from: '"AMAZONA TEAM 👻" <chetannaik775@gmail.com>', // sender address
